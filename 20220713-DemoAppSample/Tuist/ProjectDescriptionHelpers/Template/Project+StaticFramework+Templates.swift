//
//  Project+StaticFramework+Templates.swift
...
public struct StaticFrameworkDependencies {
...
public extension Project {
    static func staticFramework(name: String,
                                ...
                                packages: [Package] = [],
                                dependencies: StaticFrameworkDependencies = .init()) -> Self {
        ...
        do {
            let (target, scheme) = StaticFramework
                .makeStaticFrameworkTarget(name: name,
...
private extension Project.StaticFramework {
    static func makeStaticFrameworkTarget(name: String,
                                          deploymentTarget: DeploymentTarget,
